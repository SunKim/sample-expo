...
function Tab3Main({navigation, route}) {
	...
	const getSomeData = async () => {
		try {
			const result = await apis.TEST('hello', 'tab3')
			// console.log(`Tab3Main - getSomeData. result: `, result)
			...
			console.error(`Tab3Main - getSomeData. error: `, e)
	...
	return progress ? (
		...
		<SafeAreaView style={gs.container}>
			<ScrollView>
				<Text style={ls.text}>Tab3Main</Text>
			</ScrollView>
		</SafeAreaView>
	)
}

export default Tab3Main
