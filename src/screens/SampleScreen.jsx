...
function SampleScreen({navigation, route}) {
	...
	const getSomeData = async () => {
		try {
			const result = await apis.TEST(state.isLogin, state.user)
			// console.log(`SampleScreen - getSomeData. result: `, result)
			...
			console.error(`SampleScreen - getSomeData. error: `, e)
	...
	return progress ? (
		...
		<View style={gs.container}>
			<ScrollView>
				<Text style={ls.text}>SampleScreen</Text>
			</ScrollView>
		</View>
	)
}
